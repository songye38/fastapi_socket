...
# --- [2. 고도화된 프론트엔드 HTML (대기실 UI + 채팅방 UI 통합)] ---
html = """
<!DOCTYPE html>
<html>
    <head>
        ...
        <style>
            ...
            .hidden { display: none ! range; } /* 화면 전환용 스타일 */
